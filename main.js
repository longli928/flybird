...
var TEXT_SCORE = '已通过 %s 个';
var TEXT_GAME_OVER = '共通过%s个\n耗时%s秒\n';
var TEXT_TRY_AGAIN = '重新开始';
var TEXT_PLAY_BGM = '背景音乐';
var TEXT_TIME_ELAPSED = '用时 %s s';
var TEXT_TOTAL_TIME_ELAPSED = '累计通过 %s 个';
var TEXT_TINY_TIPS = '点按以跳跃';
